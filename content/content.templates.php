<?php
	...
	class contentExtensionEmailTemplateFilterTemplates extends AdministrationPage {
		...
		public function __viewEdit() {
			$this->addStylesheetToHead(URL . '/extensions/emailtemplatefilter/assets/emailtemplatefilter.templates.css', 'screen', 1000);
			$this->addScriptToHead(URL . '/extensions/emailtemplatefilter/assets/emailtemplatefilter.templates.js', 1000);
		...
		// Reply-To Name --------------------------------------------------------
			...
			$label->appendChild(Widget::Input(
				"conditions[{$sortorder}][reply_to]",
				General::sanitize($condition['reply_to'])
			));
		...
		// Reply-To Email ------------------------------------------------------------
			...
			$label->appendChild(new XMLElement('i', __('Optional')));
			$label->appendChild(Widget::Input(
				"conditions[{$sortorder}][reply_to_email]",
				General::sanitize($condition['reply_to_email'])
			));
